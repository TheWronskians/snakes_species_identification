...
if __name__ == "__main__":
    ...
    trdata = ImageDataGenerator(rescale=1./255,rotation_range=20,
		zoom_range=0.15,
    ...
    checkpoint = ModelCheckpoint("autoencoder_rotate.h5", monitor='val_loss', verbose=1,
    ...
    with open('r_autoencoder', 'wb') as handle:
